...
const ProjectHeroSection = ({ children }: ProjectHeroSectionProps) => (
  <section className="bg-primary flex min-h-[calc(100dvh-3.5rem)] w-full flex-shrink-0 snap-start snap-always items-center px-4 py-10 sm:min-h-[calc(100dvh-4rem)] sm:px-6 md:px-8">
