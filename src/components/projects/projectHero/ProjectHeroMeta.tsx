...
const ProjectHeroMeta = ({ period, role, techStack }: ProjectHeroMetaProps) => (
  <div className="border-foreground/10 space-y-7 border-t pt-7 sm:space-y-8 sm:pt-8">
    <div>
      <p className="text-muted-foreground mb-2 text-xs font-semibold uppercase tracking-wider sm:text-sm">
        기간
      </p>
    ...
    <div>
      <p className="text-muted-foreground mb-2.5 text-xs font-semibold uppercase tracking-wider sm:text-sm">
        기술 스택
      </p>
