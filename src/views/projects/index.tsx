...
const ProjectsLandingPage = () => {
  return (
    <>
      <section className="projects-list-page bg-primary-subtle flex min-h-[calc(100vh-3.5rem)] w-full flex-shrink-0 snap-start flex-col sm:min-h-[calc(100vh-4rem)]">
        <div className="mx-auto flex w-full max-w-[1200px] flex-1 flex-col gap-8 px-4 py-12 sm:gap-10 sm:px-6 sm:py-16 md:gap-12 md:px-8 md:py-20">
          <AnimateInView delay={0}>
            <header>
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link
                  href="/"
                  className="no-print text-foreground hover:border-foreground/15 border-foreground/[0.08] inline-flex shrink-0 items-center gap-1.5 rounded-xl border bg-white/90 px-4 py-2.5 text-sm font-medium shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md sm:gap-2 sm:px-5 sm:py-3 sm:text-base"
                >
                  전체 포트폴리오 보러 가기
          ...
          <div className="projects-list-page-section-2 flex flex-col gap-8 sm:gap-10 md:gap-12">
            <AnimateInView delay={0}>
