...
const ProjectsLandingPage = () => {
  return (
    <main className="bg-primary-subtle min-h-[calc(100vh-3.5rem)] w-full flex-shrink-0 sm:min-h-[calc(100vh-4rem)]">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col px-4 py-12 sm:px-6 sm:py-16 md:px-8 md:py-20">
